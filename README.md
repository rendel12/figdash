...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/rendel12/figdash@latest/dashedBorder.css">
<script src="https://cdn.jsdelivr.net/gh/rendel12/figdash@latest/dashedBorder.js"></script>
```
